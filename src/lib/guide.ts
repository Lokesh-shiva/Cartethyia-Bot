...
export const GUIDE_SECTIONS: Record<string, GuideSection> = {
  ...
  currencies: {
    ...
    embed: () => new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: "🔷  Fractonite",        value: "Pre-key currency — **100 Fractonite = 1 Fracture Key OR 1 Radiant Key** via `/use fractonite` (pick which). Drops from dungeons (40), bosses/field-bosses/ascension (60), voting (100/200 weekends), and first expedition (300). Not sold in `/shop` — it's earned, not bought.", inline: false },
  ...
  set_bonuses: {
    ...
    embed: () => new EmbedBuilder()
      ...
      .addFields(
        ...
        {
          name:  "✦ Named Echo Sets (new, WL2+)",
          value: [
            "6 lore-named sets, dropped by the 6 new `/field-boss` guardians. Shown with a ✦ marker in `/echo`, `/echo-equip`, `/echoes`.",
            "🔥 **Smoldering Sovereign** — 2pc +12% Fusion DMG · 4pc stacking ATK · 5pc double-hit Skill",
            "❄️ **Frostveil Bastion** — 2pc +15% DEF/+8% Glacio · 4pc Counter-Frost · 5pc panic shield <60% HP",
            "⚡ **Stormcaller's Oath** — 2pc +10% Electro/Energy · 4pc post-Ult crit buff · 5pc Thunderbolt",
  ...
  boss_challenges: {
    ...
    embed: () => new EmbedBuilder()
      ...
      .addFields(
        ...
        {
          name: "⚔️  /field-boss — Named Echo Set Bosses (requires World Level 2+)",
          value: [
            `6 tougher guardians, each with a unique fight mechanic and each guarding a piece of a **Named Echo Set** (see the Echo Sets section below).`,
            `🔥 Cinderbound Colossus — *Molten Buildup*: builds heat each turn, use Skill/Ultimate to fully vent it before it erupts.`,
            `❄️ Cryoveil Warden — *Frost Barrier*: self-heals unless you land a strong hit.`,
            `⚡ Thundercrown Herald — *Energy Surge*: unleashes a guaranteed Overcharge every few turns — no counterplay, race the clock.`,
            `🌪️ Galebound Sovereign — *Momentum Gust*: builds toward a bonus attack unless you keep pressure on it.`,
            `🌑 Voidmaw Devourer — *Lifesteal Frenzy*: heals off its own damage, enrages once below 40% HP.`,
            `✨ Lumenwrought Seraph — *Steady Regen*: regenerates every turn unless you land 2 consecutive strong hits.`,
            `**Win:** 1 guaranteed **4-cost echo** of that boss's Named Echo Set + Credits.`,
          ].join("\n"),
          inline: false,
        },
      )
  ...
  ability_evolution: {
    label: "Ability Evolution — Lv50",
    description: "Evolve your unique ability into something legendary — /evolve",
    emoji: "🌀",
    embed: () => new EmbedBuilder()
      .setColor(C.gold)
      .setTitle("🌀  Ability Evolution — Lv50")
      .setDescription(
        `At **Level 50**, you can evolve your unique passive ability into a more powerful form.\n` +
        `Evolved abilities deal **1.3× the normal cap** on all effects and gain a **4th primitive** — an extra combat property unique to your element and playstyle.\n\n` +
        `**Command:** \`/evolve\``
      )
      .addFields(
        {
          name: "Quest — 4 Ordered Steps",
          value: [
            `**1.** \`/evolve\` to begin the quest`,
            `**2.** Clear **3 dungeons** (any type)`,
            `**3.** Defeat a **WL5+ boss** via \`/boss\``,
            `**4.** Pay **5 🔮 Paradox Cores + 8 🔒 Stasis Locks** to complete the ritual`,
          ].join("\n"),
          inline: false,
        },
        {
          name: "What Changes",
          value: [
            `› All existing ability effects amplified to **1.3×** their normal max`,
            `› A **4th primitive** added — a new combat property generated by AI`,
            `› New evolved name, effect description, and lore — all AI-generated from your full player context (personality, bonds, combat record, echoes)`,
            `› Card gains **gold accents** and a 4-slot layout`,
          ].join("\n"),
          inline: false,
        },
        {
          name: "Note",
          value: "Evolution is **permanent** and required before Ego Weapon Awakening at Lv60.",
          inline: false,
        },
      )
      .setFooter({ text: "CARTETHYIA  ·  /evolve — requires Lv50 + unique ability" }),
  },

  ego_awakening: {
    label: "Ego Weapon Awakening — Lv60",
    description: "Awaken your weapon into a legendary Ego form — /awaken",
    emoji: "✦",
    embed: () => new EmbedBuilder()
      .setColor(0xFCD34D)
      .setTitle("✦  Ego Weapon Awakening — Lv60")
      .setDescription(
        `At **Level 60**, after evolving your ability, you can awaken your equipped weapon into its **Ego form** — a one-time, permanent transformation.\n\n` +
        `**Command:** \`/awaken\`\n\n` +
        `**Requirements:** Lv60+ · Evolved unique ability · Weapon equipped\n` +
        `**Cost:** 20 ⚙️ Forging Ores · 8 🔮 Paradox Cores · 20,000 💠 Credits`
      )
      .addFields(
        {
          name: "Stat Amplification",
          value: [
            `All weapon stats are multiplied by a rarity bonus:`,
            `› 3★ → **×1.15**  ·  4★ → **×1.20**  ·  5★ → **×1.25**`,
            `This applies to base ATK, main substat, and both hidden substats.`,
          ].join("\n"),
          inline: false,
        },
        {
          name: "Passive Amplification + New Effect",
          value: [
            `› Existing passive amplified **×1.25** (capped at 1.3× registry max)`,
            `› A **new effect** added — AI-generated from your full context (element, evolved ability, combat style)`,
            `› Weapon gains a new **awakened name** and **lore** — no two awakenings are the same`,
          ].join("\n"),
          inline: false,
        },
        {
          name: "Weapon Bond",
          value: [
            `Awakened weapons start at **Bond 0 (80% power)** and grow to **Bond 10 (100% power)** through combat wins.`,
            `+1 bond per boss / dungeon / field-boss win while the weapon is equipped.`,
            `Milestones: Bond 1 — *Awakening* · Bond 5 — *Resonance* · Bond 10 — *Synchrony*`,
            `Bond progress shown on \`/weapon\` and \`/profile\`.`,
          ].join("\n"),
          inline: false,
        },
        {
          name: "Art",
          value: "The awakening generates a detailed **art prompt** for custom weapon art. Drop the PNG at `assets/weapons/awakened/{Name}.png` and it appears on the weapon card automatically.",
          inline: false,
        },
      )
