...
const EMOJI_ASSETS: { name: string; file: string }[] = [
  ...
  { name: "cc_voltaic", file: "assets/icons/Voltaic Shard.png" },
  { name: "cc_glacial", file: "assets/icons/Glacial Shard.png" },
  // 1-cost echoes
  ...
  { name: "ec_cinderfang",   file: "assets/echoes/3-cost/Cinderfang Stalker.png" },
  { name: "ec_cinderreaver", file: "assets/echoes/3-cost/Cinder Reaver.png"      },
  { name: "ec_frostfang",    file: "assets/echoes/3-cost/Frostfang Stalker.png"  },
  { name: "ec_frostreaver",  file: "assets/echoes/3-cost/Frost Reaver.png"       },
  { name: "ec_voltfang",     file: "assets/echoes/3-cost/Voltfang Stalker.png"   },
  { name: "ec_galefang",     file: "assets/echoes/3-cost/Galefang Stalker.png"   },
  { name: "ec_galereaver",   file: "assets/echoes/3-cost/Gale Reaver.png"        },
  { name: "ec_umbrareaver",  file: "assets/echoes/3-cost/Umbra Reaver.png"       },
  { name: "ec_lumenfang",    file: "assets/echoes/3-cost/Lumenfang Stalker.png"  },
  { name: "ec_lumenreaver",  file: "assets/echoes/3-cost/Lumen Reaver.png"       },
  // Roster expansion (2026-09) — plain elemental echoes
  { name: "ec_blazekit",   file: "assets/echoes/1-cost/Blazekit.png"   },
  { name: "ec_torchpup",   file: "assets/echoes/1-cost/Torchpup.png"   },
  { name: "ec_snowpuff",   file: "assets/echoes/1-cost/Snowpuff.png"   },
  { name: "ec_chillkit",   file: "assets/echoes/1-cost/Chillkit.png"   },
  { name: "ec_ampkit",     file: "assets/echoes/1-cost/Ampkit.png"     },
  { name: "ec_zappup",     file: "assets/echoes/1-cost/Zappup.png"     },
  { name: "ec_flutterkit", file: "assets/echoes/1-cost/Flutterkit.png" },
  { name: "ec_breezepup",  file: "assets/echoes/1-cost/Breezepup.png"  },
  { name: "ec_gloomkit",   file: "assets/echoes/1-cost/Gloomkit.png"   },
  { name: "ec_murkpup",    file: "assets/echoes/1-cost/Murkpup.png"    },
  { name: "ec_gleamkit",   file: "assets/echoes/1-cost/Gleamkit.png"   },
  { name: "ec_shinepup",   file: "assets/echoes/1-cost/Shinepup.png"   },
  { name: "ec_sunfire",    file: "assets/echoes/3-cost/Sunfire Behemoth.png"  },
  { name: "ec_pyrewyrm",   file: "assets/echoes/3-cost/Pyrewyrm.png"          },
  { name: "ec_icicle",     file: "assets/echoes/3-cost/Icicle Colossus.png"  },
  { name: "ec_blizzardw",  file: "assets/echoes/3-cost/Blizzardwyrm.png"     },
  { name: "ec_surge",      file: "assets/echoes/3-cost/Surge Behemoth.png"   },
  { name: "ec_currentw",   file: "assets/echoes/3-cost/Currentwyrm.png"      },
  { name: "ec_draft",      file: "assets/echoes/3-cost/Draft Behemoth.png"   },
  { name: "ec_skywyrm",    file: "assets/echoes/3-cost/Skywyrm.png"          },
  { name: "ec_abyss",      file: "assets/echoes/3-cost/Abyss Behemoth.png"   },
  { name: "ec_eclipsew",   file: "assets/echoes/3-cost/Eclipsewyrm.png"      },
  { name: "ec_aurora",     file: "assets/echoes/3-cost/Aurora Behemoth.png"  },
  { name: "ec_solsticew",  file: "assets/echoes/3-cost/Solsticewyrm.png"     },
];
...
const ECHO_EMOJI_MAP: Record<string, string> = {
  ...
  "Cinderfang Stalker": "ec_cinderfang",
  "Cinder Reaver":      "ec_cinderreaver",
  "Frostfang Stalker":  "ec_frostfang",
  "Frost Reaver":       "ec_frostreaver",
  "Voltfang Stalker":   "ec_voltfang",
  "Galefang Stalker":   "ec_galefang",
  "Gale Reaver":        "ec_galereaver",
  "Umbra Reaver":       "ec_umbrareaver",
  "Lumenfang Stalker":  "ec_lumenfang",
  "Lumen Reaver":       "ec_lumenreaver",
  // Roster expansion (2026-09) — plain elemental echoes
  "Blazekit":          "ec_blazekit",
  "Torchpup":          "ec_torchpup",
  "Snowpuff":          "ec_snowpuff",
  "Chillkit":          "ec_chillkit",
  "Ampkit":            "ec_ampkit",
  "Zappup":            "ec_zappup",
  "Flutterkit":        "ec_flutterkit",
  "Breezepup":         "ec_breezepup",
  "Gloomkit":          "ec_gloomkit",
  "Murkpup":           "ec_murkpup",
  "Gleamkit":          "ec_gleamkit",
  "Shinepup":          "ec_shinepup",
  "Sunfire Behemoth":  "ec_sunfire",
  "Pyrewyrm":          "ec_pyrewyrm",
  "Icicle Colossus":   "ec_icicle",
  "Blizzardwyrm":      "ec_blizzardw",
  "Surge Behemoth":    "ec_surge",
  "Currentwyrm":       "ec_currentw",
  "Draft Behemoth":    "ec_draft",
  "Skywyrm":           "ec_skywyrm",
  "Abyss Behemoth":    "ec_abyss",
  "Eclipsewyrm":       "ec_eclipsew",
  "Aurora Behemoth":   "ec_aurora",
  "Solsticewyrm":      "ec_solsticew",
};
