    ...
    .addFields(
      {
        ...
        value: `${enc}\n-# **Empty = enemies spawn everywhere.** Set channels = only those spawn. Use **➕ Allowlist by ID** to add a whole category — paste the category ID and all channels under it are covered.`,
        inline: false,
      },
      {
