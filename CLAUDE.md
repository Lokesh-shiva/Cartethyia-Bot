...
- `gearAwareScale` in combat.ts: ALL axes hard-capped (levelScale ≤3.0, hpScale ≤2.8, atkScale ≤2.4, defScale ≤2.0; gearRatio capped 2.7 HP / 3.4 ATK; defaults levelWeight=0.65, gearWeight=1.0). Boss bases already encode WL progression — uncapped stacking one-shot every WL5+ player and made 300k+ HP slogs. 2026-07-03: caps + raid's `computeRaidBossStats`/encounter's/`/boss`'s weights all bumped ~35-40% — players reported ascend/boss/raid/encounters as too easy after several sessions of stacking player-power systems (named sets, evolved abilities, awakened weapons) with no parallel toughness pass.
